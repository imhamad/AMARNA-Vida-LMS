...
class __TwigTemplate_27b4e95787abd5227784cf78e5fd4b0e633c54456f779b034fd91c560dbf4920 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-tips.html.twig", "/Users/hamad/WebServer/hybrid-lms/web/core/themes/claro/templates/filter/filter-tips.html.twig");
    }
